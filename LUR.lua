...
local Window = redzlib:MakeWindow({
   Title = "LUR Hub : Blox Fruits",
   SubTitle = "by Leader",
   SaveFolder = "LUR Hub | Blox Fruits.lua"
})

local AFKOptions = {}

local Discord = Window:MakeTab({"Telegram", "Info"})
Discord:AddDiscordInvite({
   Name = "LUR Hub | Community",
   Description = "Join our channel to receive information about the next update",
   Logo = "rbxassetid://15298567397",
   Invite = "https://t.me/T7B7_0"
})
