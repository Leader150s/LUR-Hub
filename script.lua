...
local Window = Rayfield:CreateWindow({
   Name = "DMS HUB ⚡ نظام البحار الثلاثة",
   LoadingTitle = "جاري تحميل الواجهة...",
...
MainTab:CreateToggle({
   Name = "⚔️ تشغيل الفارم الذكي (جميع البحار)",
   CurrentValue = false,
   Flag = "AutoFarm",
   Callback = function(Value)
      _G.farming = Value
      if Value then
          -- استدعاء ملف الفارم المنفصل
